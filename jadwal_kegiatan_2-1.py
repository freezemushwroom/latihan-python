...
# versi: 2.1
# Upgrade berikutnya: Membuat aplikasi sendirinya/shortcut ke pythonnya
# keperluannya: output diubah ke window dan harus bisa input dari window itu
...
print("Halo Selamat ", kondisi_hari, "! \n\n")
aktif = 1
simpen_ga = 1
pasti = 1
...
while aktif:
    ...
    while simpen_ga:
        ...
        pW.tidur(0.2)
        if pembanding in status_Iya[:]:  # jangan lupa setelah input di kapitalisasi
            simpen_ga = 0
            while pasti:
                ...
                if cek_ is False:
                    pW.tidur(0.2)
                    print("File tersebut belum ada")
                    Input_berhasil = 1
                    while Input_berhasil:
                        tulis_ulang = input("Apakah kakak ingin membuat file baru ")
